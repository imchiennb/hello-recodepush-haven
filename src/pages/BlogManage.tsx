...
import { useMutationDeleteBlog } from "@/hooks/blog/use-mutation-delete-blog";
...
const mockBlogPosts = [
  ...
  },
  {
    ...
    category: "Security",
    thumbnail:
      "https://images.unsplash.com/photo-1510915361894-db8b60106cb1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80",
    status: "Draft",
  },
];
...
const BlogManage = () => {
  ...
  const filteredPosts = blogs?.data?.filter((post) => {
    ...
    const matchesStatus = statusFilter === "All" || post.publish === true;
    ...
    <div className="min-h-screen bg-neutral-50">
                              ...
                              >
                                <span className="sr-only">
                                  {post.status === "Published"
                                    ? t("blogManage.unpublish")
                                    : t("blogManage.publish")}
                                </span>
                                {post.status === "Published" ? (
                                  <X className="h-4 w-4" />
                                ) : (
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>
              {t("blogManage.deleteConfirmation")}
            </AlertDialogTitle>
            <AlertDialogDescription>
