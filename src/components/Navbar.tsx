      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link to="#pricing" className="text-neutral-700 hover:text-brand-600 transition-colors">
              {t('nav.pricing')}
            </Link>
            <Link to="#contact" className="text-neutral-700 hover:text-brand-600 transition-colors">
              {t('nav.contact')}
            </Link>
            {user && (
